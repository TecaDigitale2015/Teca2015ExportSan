...
/**
 * <p>Java class for c01 complex type.
 * 
 ...
 *           &lt;element name="c02" type="{urn:isbn:1-931666-22-9}c02" maxOccurs="unbounded"/>
 *         &lt;/sequence>
 *       &lt;/sequence>
...
public class C01 {
    ...
    /**
     * Gets the value of the theadAndC02 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the theadAndC02 property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<Object> getTheadAndC02() {
        if (theadAndC02 == null) {
            theadAndC02 = new ArrayList<Object>();
        }
        return this.theadAndC02;
    }
